 ...
 * @author fuxin
 */
public class CmsCustomerGroup implements Serializable {
    // 关系
    ...
    //一个用户组多个用户
    private List<CmsCustomer> customers;
    ...
    public List<CmsCustomer> getCustomers() {
        return customers;
    }

    public void setCustomers(List<CmsCustomer> customers) {
